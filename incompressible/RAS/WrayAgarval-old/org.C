...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarval-old<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarval-old<BasicTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarval-old<BasicTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1
) const
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarval-old<BasicTurbulenceModel>::fw
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WrayAgarval-old<BasicTurbulenceModel>::DnuTildaEff() const
{

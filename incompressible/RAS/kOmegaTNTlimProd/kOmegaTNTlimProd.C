...
tmp<volScalarField> 
kOmegaTNTlimProd<BasicTurbulenceModel>::F_TNT
(
...
kOmegaTNTlimProd<BasicTurbulenceModel>::Pk
(
 	const volScalarField::Internal& G
) const
{
	return min(G, this->rho_ * this->k_ * sqr(G / this->nut_)); 
}
// ****************************************************************** // 

template<class BasicTurbulenceModel>
void kOmegaTNTlimProd<BasicTurbulenceModel>::correctNut()
{
    this->nut_ = k_/omega_;
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaTNTlimProd<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> kOmegaTNTlimProd<BasicTurbulenceModel>::omegaSource() const
{
    return tmp<fvScalarMatrix>
    (
        new fvScalarMatrix
...
template<class BasicTurbulenceModel>
kOmegaTNTlimProd<BasicTurbulenceModel>::kOmegaTNTlimProd
(
...
template<class BasicTurbulenceModel>
bool kOmegaTNTlimProd<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaTNTlimProd<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
...
makeTemplatedTurbulenceModel(transportModelIncompressibleTurbulenceModel, RAS, kOmegaTNTlimProd)
